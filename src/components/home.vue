  ...
  <el-container class='home_container'>
    ...
    <el-container>
      ...
      <el-aside :width="collapseFlag ? '64px' : '200px'">
        ...
        <!-- router 是否开启路由模式 -->
         <el-menu default-active="2" background-color="#35B3EE"  text-color="#fff" active-text-color="#ffd04b" unique-opened :collapse='collapseFlag' :collapse-transition="false" router>
           <!-- 一级菜单 -->
           <!-- index属性为字符串 -->
  ...
  data() {
    return {
      ...
      menulist: [
        ...
        { id: 101, authName: '商品管理', path: 'goods', children: [{ id: 113, authName: '商品列表', path: 'goods', children: [] }, { id: 114, authName: '分类参数', path: 'lists', children: [] }, { id: 115, authName: '商品分类', path: 'goods', children: [] }] },
